  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        ...
        {/* Interactive Clue Column (Order 2 on mobile, 1 on desktop) */}
        <motion.div
          className="order-2 lg:order-1 relative flex justify-center items-center min-h-[300px] lg:h-[500px]"
        ...
        >
          ...
          >
            {/* The Clue Tooltip */}
            <motion.div
              className="absolute -top-32 left-1/2 -translate-x-1/2 w-[280px] md:w-72 p-4 glass rounded-lg border border-[#00FF9F]/30 pointer-events-none z-20"
            ...
            {/* Submarine SVG Illustration - Scaled for mobile */}
            <svg width="180" height="100" viewBox="0 0 220 120" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ filter: hoveredClue ? 'drop-shadow(0 0 25px rgba(0,255,159,0.4))' : 'drop-shadow(0 20px 30px rgba(0,0,0,0.9))', transition: 'filter 0.3s ease' }}>
        ...
        {/* Narrative Column (Order 1 on mobile, 2 on desktop) */}
        <motion.div
        ...
        >
          ...
          <div className="space-y-6 text-sm md:text-lg font-light italic max-w-[85%] lg:max-w-none" style={{ fontFamily: "'Playfair Display', serif", color: 'rgba(224, 247, 250, 0.7)' }}>
          ...
          {/* Darkness indicator */}
          <motion.div
            className="mt-8 lg:mt-12 inline-flex items-center gap-3 px-4 py-2 rounded-full shadow-[0_0_20px_rgba(0,255,159,0.1)]"
