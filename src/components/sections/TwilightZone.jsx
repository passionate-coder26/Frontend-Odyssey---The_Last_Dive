  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        animate={{
          x: [-100, 100, -100],   // reduce movement (important for big size)
          y: [-30, 30, -30],
          rotate: [-2, 2, -2]
        }}
      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        >
          ...
          <div className="space-y-6 text-base md:text-lg font-light italic" style={{ fontFamily: "'Playfair Display', serif", color: 'rgba(224, 247, 250, 0.8)' }}>
        ...
        >
          ...
          >
            <Player
              ...
              loop
              src={glowingFish}
              className="w-32 h-32 opacity-80 pointer-events-none"
              style={{
          ...
          >
            {/* The Clue Tooltip */}
            <motion.div
              className="absolute -top-24 left-1/2 -translate-x-1/2 w-56 md:w-64 p-4 glass rounded-lg border border-[#4FC3F7]/30 pointer-events-none"
